...
to setup
  ...
  ;; Create a small world network with high clustering and a small path-length,
  ;; as dictated by other network models of the brain
  nw:generate-watts-strogatz neurons dlinks num_neurons num_links_between rewire_prob [
    set shape "circle"
    set color blue
